...
const selectPeopleFeature = createFeatureSelector<fromPeople.PeopleState>('people');

const { selectAll: selectAllPeople } = fromPeople.adapter.getSelectors(selectPeopleFeature);
